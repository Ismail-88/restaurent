...
let saladf = document.getElementById("saladf");
let mainf = document.getElementById("mainf");
let dessertf = document.getElementById("dessertf");
...
let buttons = [starter, saladf, mainf, dessertf, drinkf]
